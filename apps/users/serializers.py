...
from DavinciCode.settings import REGEX_MOBILE
...
class SmsSerializer(serializers.Serializer):
    ...
    def validate_mobile(self, mobile):
        ...
        if VerifyCode.objects.filter(create_time__gt=one_mintes_ago, mobile=mobile).count():
...
class UserRegSerializer(serializers.ModelSerializer):
    ...
    def validate_code(self, code):
        ...
        verify_records = VerifyCode.objects.filter(mobile=self.initial_data["username"]).order_by("-create_time")
