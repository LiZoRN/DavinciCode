...
class ProposalsFilter(django_filters.rest_framework.FilterSet):
    ...
    pricemin = django_filters.NumberFilter(name="token_price", lookup_expr='gte',help_text='最小价格')
    pricemax = django_filters.NumberFilter(name="token_price", lookup_expr='lte')
